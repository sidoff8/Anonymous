...
class ChatFromItem(val text: String,val user: User): Item<ViewHolder>(){
    override fun bind(viewHolder: ViewHolder, position: Int) {
        viewHolder.itemView.textView_from_chatrow.text= text
        val uri = user.profileImageUrl
        val targetImageView= viewHolder.itemView.imageView_from_chatrow
...
class ChatToItem(val text: String, val user: User): Item<ViewHolder>(){
    override fun bind(viewHolder: ViewHolder, position: Int) {
        viewHolder.itemView.textView_to_chatrow.text =text

        //load our user image in chat
        val uri = user.profileImageUrl
        val targetImageView= viewHolder.itemView.imageView_to_chatrow
        Picasso.get().load(uri).into(targetImageView)
    }
